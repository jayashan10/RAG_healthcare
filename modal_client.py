...
def main():
    ...
    parser.add_argument(
        "--prompt",
        type=str,
        default="Compose a limerick about baboons and racoons and wolves.",
    ...
    # client.base_url = f"https://jayashan10--example-vllm-openai-compatible-serve-dev.modal.run"
